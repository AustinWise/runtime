...
namespace Internal.IL.Stubs.StartupCode
{
    ...
    public sealed partial class StartupCodeMainMethod : ILStubMethod
    {
        ...
        private bool _generateLibraryAndMainEntryPoints;

        public StartupCodeMainMethod(TypeDesc owningType, MethodDesc mainMethod, IReadOnlyCollection<MethodDesc> libraryInitializers, bool generateLibraryAndMainEntryPoints)
        {
            _owningType = owningType;
            _mainMethod = new MainMethodWrapper(owningType, mainMethod);
            _libraryInitializers = libraryInitializers;
            _generateLibraryAndMainEntryPoints = generateLibraryAndMainEntryPoints;
        }
        ...
        public override MethodIL EmitIL()
        {
            ...
            if (!_generateLibraryAndMainEntryPoints && _libraryInitializers != null)
            {
            ...
            if (!_generateLibraryAndMainEntryPoints && runModuleInitializers != null)
            {
